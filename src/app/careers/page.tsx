  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
        <h1 className="font-display text-4xl font-bold md:text-5xl">{content.title || "Careers"}</h1>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
        <div className="rounded-2xl border border-border bg-card p-8 md:p-12">
          <div
            ...
            dangerouslySetInnerHTML={{ __html: content.content || "<p>Career information coming soon.</p><p>Send your resume to careers@nextfitt.com</p>" }}
          />
        </div>
      </motion.div>
    </div>
