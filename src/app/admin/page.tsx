...
const RevenueChart = dynamic(() => import("@/components/admin/RevenueChart"), {
  ssr: false,
  loading: () => (
    <div className="lg:col-span-2 rounded-2xl border border-border bg-card p-6 animate-pulse">
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {/* Revenue Chart (dynamically loaded - recharts stays out of shared chunks) */}
        <RevenueChart />
